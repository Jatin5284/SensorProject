...
class DataTransformationConfig:
    artifact_dr = os.path.join(artifact_folder)
    transformed_train_file_path = os.path.join(artifact_dr , 'train.npy')
    transformed_test_file_path = os.path.join(artifact_dr , 'test.npy')
    transformed_object_file_path = os.path.join(artifact_dr , 'preprocessor.pkl')
